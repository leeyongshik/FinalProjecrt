            ...
            <div className={cartStyles.com_cart_list_wrap}>
                ...
                <ul className={cartStyles.com_list_style1}>
                    ...
                    <li class="" id="cart_item_idx_900733">
                        <input type="checkbox" id="checkbox900733" name="checkbox" value="900733" class="com_custom_checkbox" checked="checked"/>
                        <label for="checkbox900733"></label>
                        <a href="/culture-event/popcorn-store/product-detail.aspx?GG_NO=100321" class="product_info_img">
                            <img src="http://img.cgv.co.kr/GiftStore/Product/Pc/List/16678058249750.jpg" alt="CGV콤보"/>
                            <strong class="product_info_name">CGV콤보</strong>
                            <span class="product_info_origin" id="spanOriginName900733">팝콘(L)1+탄산음료(M)2</span>
                        </a>
                        <div class="product_info_wrap not_sale">
                            <span class="product_info_one_price" id="product_info_one_price900733">10,000</span>
                        </div>
                        <input type="hidden" id="hid_PKAG_CNT" value="1"/>
                        <input type="hidden" id="hid_OrderCnt900733" class="goodscnt" value="1"/>
                        <div class="product_info_cnt_wrap">
                            <span class="com_form_count com_form_count900733" id="com_form_count900733">1</span>
                            <a href="#none" onclick="javascript:$.fn.comFormNumberCnt('com_form_count900733', null, null, 1, 1, 10)" class="com_btn_plus">+</a>
                            <a href="#none" onclick="javascript:$.fn.comFormNumberCnt('com_form_count900733', null, null, -1, 1, 10)" class="com_btn_minus">-</a>
                            <a href="#none" onclick="javascript:fn_OrderAmountUpdate(900733);" class="btn_change">변경</a>
                        </div>
                        <span class="product_info_price" id="totalgoodsprice900733">10,000</span>
                        ...
                        <a href="javascript:fn_Del('900733')" class="btn_product_delect">삭제</a>
                    </li>
                    <li class="" id="cart_item_idx_900731">
                        <input type="checkbox" id="checkbox900731" name="checkbox" value="900731" class="com_custom_checkbox" checked="checked"/>
                        <label for="checkbox900731"></label>
                        <a href="/culture-event/popcorn-store/product-detail.aspx?GG_NO=100329" class="product_info_img">
                            <img src="http://img.cgv.co.kr/GiftStore/Product/Pc/List/16680650063190.jpg" alt="고소팝콘(M)"/>
                            <strong class="product_info_name">고소팝콘(M)</strong>
                            <span class="product_info_origin" id="spanOriginName900731">고소팝콘(M)</span>
                        </a>
                        <div class="product_info_wrap not_sale">
                            <span class="product_info_one_price" id="product_info_one_price900731">5,000</span>
                        </div>
                        <input type="hidden" id="hid_PKAG_CNT" value="1"/>
                        <input type="hidden" id="hid_OrderCnt900731" class="goodscnt" value="1"/>
                        <div class="product_info_cnt_wrap">
                            <span class="com_form_count com_form_count900731" id="com_form_count900731">1</span>
                            <a href="#none" onclick="javascript:$.fn.comFormNumberCnt('com_form_count900731', null, null, 1, 1, 10)" class="com_btn_plus">+</a>
                            <a href="#none" onclick="javascript:$.fn.comFormNumberCnt('com_form_count900731', null, null, -1, 1, 10)" class="com_btn_minus">-</a>
                            <a href="#none" onclick="javascript:fn_OrderAmountUpdate(900731);" class="btn_change">변경</a>
                        </div>
                        <span class="product_info_price" id="totalgoodsprice900731">5,000</span>
                        <div class="product_info_btn_wrap">
                        ...
                        <a href="javascript:fn_Del('900731')" class="btn_product_delect">삭제</a>
                    </li>
                </ul>
                ...
                <table class="com_cart_total_price_wrap" summary="총 상품 금액, 할인금액을 합산한 총 결제예정 금액 표기">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><strong class="cart_total_price"><span id="sTot_Promotion_Price">17,500</span></strong></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="com_btn_wrap pT60">
                    <a href="#none" class="btn_style0 " onclick="javascript:fn_Buy(this, 'gift', '');">선물하기</a>
                    <a href="#none" class="btn_style0 " onclick="javascript:fn_Buy(this, 'purchase', '');">구매하기</a>
                </div>
            </div>
        </div>
    );
